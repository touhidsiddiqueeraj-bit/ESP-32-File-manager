...
ESP32-S3 File Manager License UI
...
Smart WiFi Connectivity: Automatically connects to your home WiFi. If it fails, it instantly falls back to Access Point (AP) mode with a Captive Portal—just connect to the ESP32 WiFi and the file manager pops up automatically.
...
Open the .ino file and modify the following variables at the top:

cpp

const char* ssid = "YOUR_HOME_WIFI";       // Your home WiFi name
const char* password = "YOUR_WIFI_PASSWORD"; // Your home WiFi password

const char* ap_ssid = "ESP32-S3-Drive";    // Fallback AP name
const char* ap_password = "12345678";      // Fallback AP password
